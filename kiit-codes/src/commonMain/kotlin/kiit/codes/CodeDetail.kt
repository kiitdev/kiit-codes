 ...
 * (`type`/`title`/`status`). No HTTP status code, since this is meant for internal
 * service-to-service calls, background jobs, and any other non-API path where an HTTP status
